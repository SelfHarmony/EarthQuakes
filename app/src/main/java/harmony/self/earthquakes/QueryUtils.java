...
public final class QueryUtils {
    ...
    public static ArrayList<EarthQuake> fetchEarthquakeData(String requestUrl){
        ...
        Log.i(LOG_TAG, "QueryUtils fetchEarthquakeData");
        // Create URL object
    ...
    public static ArrayList<EarthQuake> extractEarthquakes(String inputJson) {
        ...
        try {
            ...
            JSONObject earthquakesJsonObject = new JSONObject(inputJson);
            JSONArray features = earthquakesJsonObject.optJSONArray("features");
            ...
            //  АЛЬТЕРНАТИВНЫЙ СПОСОБ ПЕРЕДЕАЧИ ПАРАМЕТРА ВРЕМЕНИ (ЧЕРЕЗ СТРОКУ)
                ...
                Date ourDate = new Date(Long.parseLong(time));
                SimpleDateFormat dateToDisplay = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");
